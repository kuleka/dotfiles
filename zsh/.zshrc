...
# MySQL PATH (if using MySQL)
# export PATH=$PATH:/usr/local/mysql/bin

# API Keys - ADD YOUR OWN KEYS HERE
# export OPENAI_API_KEY='your-openai-api-key-here'
# export OTHER_API_KEY='your-other-api-key-here'

# Homebrew config
export PATH="/opt/homebrew/bin:$PATH"

# Firebase credentials - SET YOUR OWN PATH
# export YOUR_FIREBASE_CREDENTIAL=/path/to/your/firebase-credentials.json

# SSH aliases - ADD YOUR OWN SERVER CONFIGS
# alias your-server='ssh -i ~/.ssh/your-key.pem user@your-server-ip'
...
# Terminal integrations (uncomment as needed)
# [[ "$TERM_PROGRAM" == "your-terminal" ]] && . "$(your-terminal --locate-shell-integration-path zsh)"
